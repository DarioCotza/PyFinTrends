...
timeframes = {
    '1d' : 'now 1-d', '1mo' : 'today 1-m',
     '3mo' : 'today 3-m','1y' : 'today 12-m', '5y' : 'today 5-y'
            }
nations = [
    "AD","AE","AG","AI","AL","AM","AN","AO","AR","AS","AT",
    ...
    "GP","GQ","GR","GS","GT","GU","GW","GY","HK","HN","HR",
    ...
    "TJ","TK","TM","TN","TO","TP","TR","TT","TV","TW","TZ",
